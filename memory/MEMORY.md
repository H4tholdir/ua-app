# UÀ — Project Memory
**Ultimo aggiornamento:** 3 luglio 2026 — B8 (1/5, /magazzino/nuovo) chiuso e deployato su main (merge `a810c36`) — CTA magazzino ora funzionante. B8 (2/5, /listino/nuovo) risolto e verificato sul branch `worktree-b8-listino-nuovo` (non ancora mergiato) — CTA listino ora funzionante e gated per ruolo.
...
**Nota:** lavoro completato e verificato sul branch `worktree-b8-listino-nuovo`, non ancora mergiato su `main` — merge/deploy da eseguire in sessione separata seguendo lo stesso processo di review whole-branch usato per B2/B7/B8(1/5).

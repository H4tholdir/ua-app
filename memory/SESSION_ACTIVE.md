...
sei guardie verdi · **5353 prove passate | 56 saltate su 443 file** (ieri sera: 5168 | 56 su 437).

🔴 **La §0 in una frase — sette cose non fatte:** ① un testo che l'app mostra è **falso** e lo sappiamo
(`classifica.ts:164` dice «non tocca il documento» mentre D288 lo annulla) · ② `riapri_lavoro_atomica`
ha un chiamante **deciso** e ancora **nessuno che la chiami** · ③ l'elenco degli effetti dei nove motivi
è pieno per **sette su nove**, e va completato **prima** del cancello §0B · ④ i compiti **5-9** non
toccati, e il **7 non si chiude prima di D283** · ⑤ il compito del **ritiro** non ha un numero, e il

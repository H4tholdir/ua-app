...
**Ultimo aggiornamento:** 04 luglio 2026 — **S4 (Email template branding) COMPLETO**: rebrand DS v2.3 dei 3 template Supabase Auth applicato via `claude-in-chrome` (Francesco ha connesso la sua sessione Chrome), verificato byte-per-byte e con un invio reale (reset password) confermato nei log Auth. B9 risolto (`ea2a3a9`) — lista pazienti ora navigabile.

...
| B5 | Download DdC/Buono da portale impossibile | ✅ | 06/07/2026 · worktree `worktree-b5-download-signed-url` (12 commit, `04e3047..7e516de`) | Non ancora mergiato su `main`. Scope ampliato in ricerca: WhatsApp al dentista mai inviato + bug trasversale URL pubbliche rotte su bucket privato (anche TabDocumenti/TabImmagini/fatture). Vedi dettaglio sotto e `memory/MEMORY.md` §0 |
...
### B5. ✅ RISOLTO (06/07/2026, worktree `worktree-b5-download-signed-url`, 12 commit `04e3047..7e516de`, non ancora mergiato su `main`) — Download DdC/Buono dal portale dentista strutturalmente impossibile
...
**QA browser raccomandata prima del merge** (non ancora eseguita in questa sessione): elenco scenari nella sezione "Nota per la prossima sessione" del piano — consegna reale con bottone WhatsApp, Front Desk con bottone WHATSAPP esplicito, portale con/senza documenti generati, tab Docs/Foto senza più 400, download XML fatture.

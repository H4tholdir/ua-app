...
const styles = {
  ...
  card: {
    ...
    maxWidth: 480,
    boxShadow: [
      '-3px -3px 7px hsl(220 80% 35% / 0.55)',
  ...
  select: {
    ...
    boxShadow: [
      'inset 3px 3px 8px hsl(230 100% 4% / 0.8)',
  ...
  dangerBtn: {
    ...
    cursor: 'pointer',
    boxShadow: '-2px -2px 6px hsl(355 100% 35% / 0.4), 3px 3px 10px hsl(230 100% 4% / 0.9)',
        ...
        >
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={styles.fieldset}>
              ...
              <span
                id="costo-hint"
                style={{ fontFamily: 'DM Sans, sans-serif', fontSize: 11, color: '#8899CC', marginTop: 4, display: 'block' }}
              >

...
export default function AdminNav({ userDisplay }: Props) {
  ...
  return (
    <nav className="adm-nav">
      ...
      {/* Toggle light/dark — Uiverse.io by Galahhad */}
      <label className="adm-theme-switch" aria-label="Cambia tema">
        <input
          type="checkbox"
          className="adm-theme-switch__checkbox"
          checked={isDark}
          onChange={toggle}
          aria-label="Modalità scura"
        />
        <div className="adm-theme-switch__container">
          <div className="adm-theme-switch__clouds" />
          <div className="adm-theme-switch__stars-container">
          ...
          <div className="adm-theme-switch__circle-container">
            <div className="adm-theme-switch__sun-moon-container">
              <div className="adm-theme-switch__moon">
                <div className="adm-theme-switch__spot" />
                <div className="adm-theme-switch__spot" />
                <div className="adm-theme-switch__spot" />
              </div>
            </div>
